...
class ComprehensiveTestSuite(unittest.TestCase):
  ...
  def test_all(self):
    # nullTest
    self.assertEqual(fold_to_ascii.fold(None), u"", "This is expected to return the empty string.")


    # numberTest
    self.assertEqual(fold_to_ascii.fold(u'123456789'), u"123456789", "This is expected to return a numeric sequence.")


    # emptyTest
    self.assertEqual(fold_to_ascii.fold(u""), u"", "This is expected to return the empty string.")
    ...
    # spaceTabTest
    self.assertEqual(fold_to_ascii.fold(u" 	 "), u" 	 ", "This is expected to return a space-tab-space sequence.")


    # escapeSequenceTest
    self.assertEqual(fold_to_ascii.fold(u" \b \t \n \v \f \r "), u" \b \t \n \v \f \r ", "This is expected to return the escape sequences \\b \\t \\n \\v \\f \\r.")
    ...
    # asciiPrintableTest
    self.assertEqual(fold_to_ascii.fold(u"0123456789:<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ !\"#$%&'()*+,-./"), u"0123456789:<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ !\"#$%&'()*+,-./", "This is expected to return the ASCII printable characters.")
